---
title: "Publications"
description: "Peer-reviewed publications by Arash Bagherabadi (Arash B. Abadi) in computational biology, machine learning, epigenetics, cardiomyopathy, and prostate cancer."
...
<div class="content publication-page-intro">
  <p>Peer-reviewed work across computational biology, epigenetics, cardiovascular disease, and prostate cancer. Each visual below comes from the corresponding open-access article.</p>
</div>
...
<div class="publication-archive">
  <article class="publication-feature">
    <figure class="publication-figure">
      ...
      <figcaption>Machine-learning workflow, Figure 3 from the article.</figcaption>
    </figure>
  ...
  <article class="publication-feature">
    <figure class="publication-figure">
      ...
      <figcaption>PPI network of hub genes, Figure 3 from the article.</figcaption>
    </figure>
    <div class="publication-feature-copy">
  ...
  <article class="publication-feature">
    <figure class="publication-figure publication-figure-wide">
      ...
      <figcaption>Graphical abstract supplied by the author.</figcaption>
    </figure>
    <div class="publication-feature-copy">
  ...
  <article class="publication-feature">
    <figure class="publication-figure">
      ...
      <figcaption>Epigenetic regulation, Figure 3 from the article.</figcaption>
    </figure>
    <div class="publication-feature-copy">

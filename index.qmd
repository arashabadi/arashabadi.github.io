      ...
      <div class="project-list">
        <article class="project-row">
          ...
          <figure class="project-thumb">
            <img src="images/project-elispot-reader.webp" alt="OpenSpotScope ELISPOT plate reader with annotated hardware components" loading="lazy" decoding="async">
          </figure>
        ...
        <article class="project-row">
          ...
          <figure class="project-thumb">
            <img src="images/project-cellrank-learning-lab.jpg" alt="CellRank 2 Learning Lab interactive trajectory explorer" loading="lazy" decoding="async">
          </figure>
          <div class="project-copy">
            <h3>CellRank 2 Learning Lab</h3>
            <p>An interactive single-cell education app that connects intuitive 3D trajectories to kernels, transition matrices, fate probabilities, slides, notes, and runnable notebooks.</p>
          </div>
        ...
        <article class="project-row">
          ...
          <figure class="project-thumb project-thumb-contain">
            <img src="images/project-patoq-book.webp" alt="PATOQ book cover combining Persian heritage with bioinformatics and machine learning" loading="lazy" decoding="async">
          </figure>
          <div class="project-copy">
            <h3>PATOQ Book</h3>
        ...
        <article class="project-row">
          ...
          <figure class="project-thumb project-thumb-contain">
            <img src="images/project-codefest-embedding-mafia.webp" alt="Embedding Mafia graphic for the CM4AI CodeFest 2025 project" loading="lazy" decoding="async">
          </figure>
          <div class="project-copy">

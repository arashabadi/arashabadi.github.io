  ...
  <section class="about-band" id="about" aria-labelledby="about-title">
    <div class="section-inner about-layout">
      ...
      <div class="about-copy">
        <h2 id="about-title"><span class="about-umbrella">Small Worlds, Large Systems</span>I study living systems, build computational ones, and make complex ideas tangible.</h2>
    ...
    <div class="section-inner">
      <div class="section-heading-row practice-heading">
        <div>
          ...
          <h2 id="practice-title">From immune systems to working tools.</h2>
          <p class="practice-summary">I am a PhD student at UAB studying immune biology with spatial and computational methods, especially where the work can inform vaccines and immunotherapy.</p>
        </div>
      </div>
      ...
      <div class="practice-grid">
        ...
        <article class="practice-item">
          ...
          <p>Lab robotics, 3D printing, educational tools, scientific writing, visual design, miniature art, mathematics, and useful experiments.</p>
        </article>
      </div>
      <p class="practice-personal">Outside the lab, I run, spend time in nature, and occasionally play pickleball.</p>
    </div>
  </section>
